...
export default function Footer() {
	return (
		<>
			<Segment inverted vertical style={{ margin: "2em 0em 0em", padding: "2em 0em" }} className="footer-container">
				<Container textAlign="center">
					...
					<Image centered size="mini" src={Logo} style={{ width: "auto", height: 60 }} />
					<div className="style__copyright" style={{ margin: 0 }}>
						© 2022 <strong>Pharma First</strong> . All rights reserved. In compliance with Drugs and Cosmetics Act, 1940
						and Drugs and Cosmetics Rules, 1945, we don't process requests for Schedule X and other habit forming drugs.
					</div>
				</Container>
			</Segment>
		</>
