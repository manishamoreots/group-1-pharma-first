                  ...
                  <div style={{ width: "80%" }}>
                    ...
                    >
                      ...
                      >
                        ...
                        <p style={{marginLeft:"20px",fontSize:"15px",fontFamily:"cursive"}}>{user?.name}</p>
                      </div>
                      ...
                      >
                        ...
                        <p style={{marginLeft:"32px",fontSize:"15px",fontFamily:"cursive"}}>{user?.email}</p>
                      </div>
                      ...
                      >
                        ...
                        <p style={{marginLeft:"18px",fontSize:"15px",fontFamily:"cursive"}}>{user.mobile ? user.mobile : "Please Update"}</p>
                      </div>
