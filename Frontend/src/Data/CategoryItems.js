export const categoryItems = [
	...
	},
	{
		...
		itemPrice: "₹557",
		highlights: ["Helps with liver and kidney functions", "Relieves cramps and sleeplessness", "Aids in regulating sugar levels"],
		desc: {
			keybenefit: [
			...
			directions: ["Read the label carefully or as directed by your physician."],
			Safetyinfo: [
				"Do not exceed the recommended dosage",
				"Pregnant or lactating or prone to any food allergy or under any medical condition or undergoing any treatment, consult the health care professional",
				"Read the label carefully before use",
	...
	// categoryID:5 starts here {Bone Joint muscles}
	{
		...
		desc: {
			...
			directions: ["Take two tablets daily or as prescribed by your medical practitioner."],
			Safetyinfo: [
				"Do not exceed the recommended dosage",
				"Pregnant or lactating or prone to any food allergy or under any medical condition or undergoing any treatment, consult the health care professional",
				"Read the label carefully before use",
	...
	},
	{
		...
		desc: {
			...
			directions: ["Take one softgel capsule daily or use as suggested by your healthcare professional "],
			Safetyinfo: [
				"Do not exceed the recommended dosage",
				"Pregnant or lactating or prone to any food allergy or under any medical condition or undergoing any treatment, consult the health care professional",
				"Read the label carefully before use",
	...
	},
	{
		...
		desc: {
			keybenefit: ["Helps to enhance memory", "Aids in improving the immunity level", "Supports eye and heart health"],
			directions: ["One tablet per day or as directed by the healthcare practitioner "],
			Safetyinfo: [
				"Do not exceed the recommended dosage",
				"Pregnant or lactating or prone to any food allergy or under any medical condition or undergoing any treatment, consult the health care professional",
				"Read the label carefully before use",
	...
	},
	{
		id: 47,
		categoryId: 5,
		itemName: "Blackmores Shine Power D3 Capsule for Healthy Teeth, Stronger Bones & Boosted Immunity",
		itemPrice: "₹1007",
		highlights: [
	...
	},
	{
		...
		desc: {
			...
			directions: ["One tablet daily preferably after a meal or as directed by the dietician"],
			Safetyinfo: [
				"Read the label carefully before use",
				"Store in a cool dry place away from direct sunlight",
				"Keep out of reach of the children",
	...
	// categoryId:6 starts here eye { eye care}
	{
		id: 51,
		categoryId: 6,
		itemName: "Zingavita Sharp Eye Multivitamin Gummies for Kids (with Essential Eye Vitamins) Strawberry Mix",
		itemPrice: "₹249",
		highlights: ["Supports eye health", "Improves sleep quality", "Helps in brain development"],
		desc: {
			keybenefit: [
			...
			directions: ["Children 5+ years old: Chew 2 gummies daily or as directed."],
			Safetyinfo: [
				"Read the label carefully before use",
				"Keep out of reach of the children",
	...
	},
	{
		...
		desc: {
			...
			directions: ["Daily 1 tablet after lunch or dinner. Do not take on an empty stomach."],
			Safetyinfo: [
				"Read the label carefully before use",
				"Store in a cool and dry place",
				"Keep it away from the reach of children",
	...
	},
	{
		...
		desc: {
			...
			directions: ["Take one capsule daily for adults as directed by your healthcare professional."],
			Safetyinfo: [
				"Read the label carefully before use",
				"Store in a cool and dry place",
				"Keep it away from the reach of children",
	...
	},
	{
		...
		itemPrice: "₹190",
		highlights: ["It can improve eye health", "It may enhance skin health", "It has antioxidant properties"],
		desc: {
			keybenefit: [
	...
	},
	{
		...
		desc: {
			...
			directions: ["Take Lobun Forte Capsule orally, twice a day or as directed by the physician."],
			Safetyinfo: [
				"Read the label carefully before use",
				"Keep out of reach of the children",
				"The product should not be used as a substitute for a varied diet",
	...
	},
	{
		...
		desc: {
			...
			directions: ["One capsule daily, during or immediately after a meal, or as recommended by a healthcare professional."],
			Safetyinfo: [
				"Read the label carefully before use",
				"Keep out of reach of the children",
				"The product should not be used as a substitute for a varied diet",
	...
	},
	{
		...
		itemPrice: "₹127",
		highlights: ["Helps relieve urinary tract problems", "Used for treating indigestion", "Increases strength in the body"],
		desc: {
			keybenefit: [
	...
	},
	{
		...
		desc: {
			...
			directions: ["Take 2 tablets a day, post meals with lukewarm water or as directed by the physician."],
			Safetyinfo: [
				"Read the label carefully before use",
				"Keep out of reach of the children",
				"The product should not be used as a substitute for a varied diet",
	...
	},
	{
		...
		desc: {
			...
			directions: ["Take 2-3 drops of dilution in 1 teaspoon of water thrice a day or as directed by the physician."],
			Safetyinfo: [
				"Read the label carefully before use",
				"Keep out of reach of the children",
				"The product should not be used as a substitute for a varied diet",
	...
	},
	{
		...
		desc: {
			...
			directions: ["Take 1 to 2 tablets with water twice a day or as advised by the physician."],
			Safetyinfo: [
				"Read the label carefully before use",
				"Keep out of reach of the children",
				"The product should not be used as a substitute for a varied diet",
	...
	},
	{
		...
		itemPrice: "₹240",
		highlights: ["Supports renal health", "Made using natural herbs", "Prevents kidney disorders"],
		desc: {
			keybenefit: [
	...
	//categoryID:8 starts here {Pain relief}
	{
		...
		itemPrice: "₹206",
		highlights: ["It may relieve pain", "It may relieve pain in the joints", "It can work great on sports injuries"],
		desc: {
			keybenefit: [
	...
	},
	{
		id: 73,
		categoryId: 8,
		itemName: "Moov Pain Relief Cream for Back Pain, Joint Pain, Knee Pain, Muscle Pain",
		itemPrice: "₹68",
		highlights: [
	...
	},
	{
		...
		desc: {
			...
			Safetyinfo: ["Read the label carefully before use", "Keep out of reach of the children"],
		},
		itemImage:
	...
	},
	{
		...
		desc: {
			...
			directions: ["Gently massage 5ml to 10ml on the affected area. Repeat it twice a day or as directed by the physician."],
			Safetyinfo: [
				"Do not exceed the recommended dosage",
				"Read the label carefully before use",
				"Store in a cool, dry place away from direct sunlight",
	...
	},
	{
		...
		desc: {
			...
			directions: ["Apply 2 to 4 gm gently on the affected area, 3 to 4 times a day and wash your hands thoroughly after use."],
			Safetyinfo: [
	...
	},
	{
		...
		desc: {
			...
			directions: ["Apply Volini Maxx Gel on the skin and rub slowly till completely absorbed."],
			Safetyinfo: [
				"Keep away from children",
				"Read the label carefully before use",
				"Store in a cool, dry place away from direct sunlight",
	...
	},
	{
		...
		desc: {
			...
			directions: ["You should take it as your doctor advises", "Do not take more or use it for longer than recommended"],
			Safetyinfo: [
				"Keep away from children",
				"Read the label carefully before use",
				"Store in a cool, dry place away from direct sunlight",
	...
	},
	{
		...
		itemPrice: "₹1155",
		highlights: ["Boosts immunity and maintains a fit body", "Relieves joint pain", "Aids in managing respiratory-related concerns"],
		desc: {
			keybenefit: [
			...
			directions: ["Take 1 to 2 tablespoonfuls morning-evening on an empty stomach or as directed by the ayurvedic doctor."],
			Safetyinfo: [
				"Keep away from children",
				"Read the label carefully before use",
				"Store in a cool, dry place away from direct sunlight",
	...
	},
	{
		id: 82,
		categoryId: 9,
		itemName: "Tata 1mg 3 Ply Surgical Mask with Meltblown Filter and Nose Pin 50 Mask Light Blue",
		itemPrice: "₹392",
		highlights: [
		...
		desc: {
			...
			Safetyinfo: ["Read the label carefully before use", "Discard after every use or if it is damaged, torn, or loose"],
		},
		itemImage:
	...
	},
	{
		...
		desc: {
			...
			directions: ["1 patch a day for 4 weeks", "Please refer to the Therapy Schedule for usage instructions"],
			Safetyinfo: [
				"Keep away from children",
				"Read the label carefully before use",
				"Store in a cool, dry place away from direct sunlight",
	...
	},
	{
		...
		itemPrice: "₹1266",
		highlights: ["Easy to read OLED display", "Measures pulse rate as well", "Easy to use the device for spot checks"],
		desc: {
			keybenefit: [
			...
			directions: ["Insert your finger and the results will be displayed on the display within 5 seconds."],
			Safetyinfo: [
				"Keep away from children",
				"Read the label carefully before use",
				"Store in a cool, dry place away from direct sunlight",
	...
	},
	{
		...
		desc: {
			...
			Safetyinfo: ["Store in a cool and dry place (below 25°C).", "Protect from moisture.", "Keep out of reach of children."],
		},
		itemImage:
	...
	},
	{
		...
		desc: {
			...
			directions: ["Take one lozenge every three hours or as directed by the physician"],
			Safetyinfo: [
				"Do not exceed the recommended dose",
				"Read the label carefully before use",
	...
	},
	{
		...
		desc: {
			...
			directions: ["Children: 1 teaspoon 3-4 times a day", "Adults: 2 teaspoons 3-4 times a day"],
			Safetyinfo: [
				"Do not exceed the recommended dose",
				"Read the label carefully before use",
				"Keep out of the reach and sight of children",
